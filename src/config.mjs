...
function validateRuntime(raw) {
  ...
  object(raw.codex, ['bin', 'cwd', 'envNames', 'model', 'rolloverIdleMs', 'rolloverOnRulesUpdate', 'rulesFiles', 'steering', 'proxyEnv', 'jobRetryMs', 'jobMaxAttempts'], 'invalid_codex_fields');
  ...
  object(raw.feishu, ['connectionId', 'appIdEnv', 'appSecretEnv', 'botOpenId', 'displayName', 'catchup', 'mediaBudgetBytes', 'outputBudgetBytes', 'httpProxyEnv'], 'invalid_feishu_fields');
